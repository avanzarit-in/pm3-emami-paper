...
public class SQSExtendedClientExample {
    ...
    public static void main(String[] args) {
        ...
        final String QueueName = "sap-inbound.fifo";
        GetQueueUrlRequest getQueueUrlRequest = new GetQueueUrlRequest(QueueName);
        final String myQueueUrl = sqsExtended
                .getQueueUrl(getQueueUrlRequest).getQueueUrl();
        System.out.println("Queue Url : "+myQueueUrl);

        // Send the message.
        final SendMessageRequest myMessageRequest =
                new SendMessageRequest(myQueueUrl, myLongString);
        myMessageRequest.withMessageGroupId("grp1");
